#ifndef MOJAVE_TRS80M3_VIDEO_CONTROLLER_HPP
#define MOJAVE_TRS80M3_VIDEO_CONTROLLER_HPP
...
class Trs80M3VideoController : public Device {
public:
    ...
    static constexpr uint16_t kCellWidth = 8;
    ...
    explicit Trs80M3VideoController(Framebuffer& fb);
