#ifndef MOJAVE_ZX80_CHARACTER_ROM_HPP
#define MOJAVE_ZX80_CHARACTER_ROM_HPP

#include <array>
#include <cstdint>
#include <functional>

class Zx80CharacterRom {
public:
    static constexpr uint16_t kCharsetBase = 0x0E00;
    static constexpr uint16_t kCharsetEndExclusive = 0x1000;
    static constexpr uint8_t kIRegister = 0x0E;
    static constexpr unsigned kGlyphCount = 64;
    static constexpr unsigned kGlyphRows = 8;
    static constexpr uint8_t kInvertBit = 0x40;
