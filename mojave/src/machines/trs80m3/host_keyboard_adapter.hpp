#ifndef MOJAVE_TRS80M3_HOST_KEYBOARD_ADAPTER_HPP
#define MOJAVE_TRS80M3_HOST_KEYBOARD_ADAPTER_HPP
...
public:
    ...
    explicit Trs80M3HostKeyboardAdapter(Trs80M3Keyboard& keyboard);
    ...
    void pulseSpecialKey(Trs80M3Keyboard::SpecialKey key);
    bool hostKeyDown(char name);
    void hostKeyUp(char name);
    bool hostSpecialDown(Trs80M3Keyboard::SpecialKey key);
    void hostSpecialUp(Trs80M3Keyboard::SpecialKey key);
...
private:
    ...
    Trs80M3Keyboard& keyboard_;
    std::array<std::array<bool, Trs80M3Keyboard::kBitsPerRow>, Trs80M3Keyboard::kRowCount> host_down_{};
    std::array<std::array<uint8_t, Trs80M3Keyboard::kBitsPerRow>, Trs80M3Keyboard::kRowCount> release_hold_{};
