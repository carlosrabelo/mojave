...
- [x] BRK, RTI, IRQ, NMI, flag instructions
- [x] NMOS unofficial opcodes (NOP variants, KIL/JAM, LAX, SAX, DCP, ISB, SLO, RLA, SRE, RRA, and remaining undocumented)
...
- [x] Plug into SDL/Qt6 virtual screen
- [x] Wire keyboard matrix to SDL/Qt6 host input
- [x] Host layout keyboard typing (SDL/Qt6; ZX key legends)
